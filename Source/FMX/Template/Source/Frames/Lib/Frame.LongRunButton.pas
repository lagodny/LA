...
uses
  ...
  FMX.Types, FMX.Graphics, FMX.Controls, FMX.Forms, FMX.Dialogs, FMX.StdCtrls, Frame.Base, FMX.Controls.Presentation, FMX.Objects;

type
  TThreadFailProcedure = reference to procedure (const aMsg: string);

  TLongRunButtonFrame = class(TBaseFrame)
