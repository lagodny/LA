...
function GetClient(const aServerAddress, aUserName,aPassword: string;
  ...
  const aProxyName: string = ''; const aProxyByPass: string = '';
  aSendTimeout: Cardinal = cSendTimeout; aReceiveTimeout: Cardinal = cReceiveTimeout;
  aConnectionTimeOut: Cardinal = cConnectionTimeOut
  ): TSQLRestClientHTTP;
...
function GetClient(const aServerAddress, aUserName,aPassword: string;
  aServerPort: integer; const aServerRoot: string; aHttps: boolean;
  const aProxyName, aProxyByPass: string;
  aSendTimeout, aReceiveTimeout, aConnectionTimeOut: Cardinal): TSQLRestClientHTTP;
begin
  result := TSQLRestClientHTTP.Create(aServerAddress,aServerPort,
    //nil,
    GetModel(aServerRoot),
    true,
    aHttps,
    aProxyName, aProxyByPass,
    aSendTimeout, aReceiveTimeout, aConnectionTimeOut
    );
  try
